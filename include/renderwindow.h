...
public:
	...
	void renderGrid(int x, int y, SDL_Texture* p_tex, Grid* grd, SDL_Rect src, int rot = 0);
	void renderGrid(int x, int y, Grid* grd, int r, int g, int b);
	void drawRect(int r, int g, int b, SDL_Rect* src);
};
